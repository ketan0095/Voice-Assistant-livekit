...
async def handle_participant_disconnected(session: AgentSession, ctx: JobContext,
    ...
    try:
        if participant.kind == rtc.ParticipantKind.PARTICIPANT_KIND_AGENT:
            ...
            logger.info(f"Participant {participant.identity} disconnected ({participant.kind})")  # noqa: E501
